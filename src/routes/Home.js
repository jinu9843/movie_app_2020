...
import './Home.css';
class Home extends React.Component{ // App 컴포넌트는 클래스라서 (함수가 아니라서)return문을 사용할수 없고 그래서 함수 형태의 App컴포넌트처럼JSX를 반환할수가 없다 클래스형 컴포턴트에서는 JSX를 반환하기 위해 render()함수를 사용한다.
